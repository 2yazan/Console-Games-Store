  ...
  return (
    <MainLayout>
      ...
      <div className="min-h-[calc(100vh_-_100px_-_534px)] flex flex-col sm:justify-center items-center py-20 px-4 md:px-0 bg-gray-50 dark:bg-gray-900">
        <Link
          href="/"
          className="flex items-center mb-6 text-2xl font-bold text-green-700 dark:text-white"
        >
          <img
        ...
        <Card className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-xl dark:bg-gray-800 dark:border-gray-700">
          <div className="p-2 space-y-4 md:space-y-6">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={submit}>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <Label
                    ...
                    htmlFor="terms"
                  >
                    By signing up, you are creating a Game Store account, and
                    you agree to Game Store's and{" "}
                    <Link
                      className="font-medium text-green-700 hover:underline dark:text-cyan-600"
                      href="#"
                    >
                      Terms of Use{" "}
                    </Link>
              ...
              <Button color="success" fullSized type="submit" disabled={processing}>
                Create an account
              </Button>
