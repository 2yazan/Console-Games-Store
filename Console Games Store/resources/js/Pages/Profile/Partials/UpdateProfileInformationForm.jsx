        ...
        <div className="flex flex-col items-center">
          ...
          {showAvatar && (
            <button
              onClick={resetAvatar}
              type="button"
              className="mt-3 text-green-700 hover:text-white border border-cyan-700 hover:bg-green-700	 focus:ring-2 focus:outline-none focus:ring-cyan-300 font-medium rounded-full text-sm px-5 py-1 text-center dark:border-cyan-500 dark:text-cyan-500 dark:hover:text-white dark:hover:bg-cyan-500 dark:focus:ring-cyan-800"
            >
              Remove
            </button>
          )}
