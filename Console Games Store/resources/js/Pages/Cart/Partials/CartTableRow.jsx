...
export default function CartTableRow({ cart }) {
  ...
  const price = cart.game_owner.price.toLocaleString("en-MY", {
    style: "currency",
    currency: "USD",
    maximumFractionDigits: 2,
  });

  const totalPrice = (cart.game_owner.price * cart.quantity).toLocaleString(
    "en-MY",
    {
      style: "currency",
      currency: "USD",
    ...
    <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
      <Table.Cell>
        <div className="flex items-center space-x-3 md:space-x-6">
          ...
          >
            <img
              src={`/game-images/${cart.game_owner.image}`}
