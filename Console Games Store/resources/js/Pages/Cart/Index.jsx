...
export default function Index() {
  ...
  const totalPrice = carts
    .map((cart) => cart.game_owner.price * cart.quantity)
              ...
              <div className="flex flex-col border dark:border-gray-700 rounded-lg py-4 px-6 bg-white dark:bg-gray-800">
                ...
                <div className="flex items-center py-3">
                  <Link
                    ...
                    className="w-full text-white bg-green-700	 hover:bg-cyan-800 focus:outline-none focus:ring-2 focus:ring-cyan-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-cyan-600 dark:hover:bg-green-700	 dark:focus:ring-cyan-800"
                  >
                    Check Out
                  </Link>
                </div>
        ...
        {carts.length < 1 && (
          <div className="flex flex-col space-y-4 max-w-xs">
            ...
            <Button color="success"
              onClick={() => router.get(route("game.index"))}
