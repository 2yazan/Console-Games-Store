              ...
              <form onSubmit={submit} className="space-y-4">
                ...
                <div className="flex justify-between items-center pt-4">
                  <Link
                    ...
                    className="flex items-center text-sm hover:underline text-green-700 hover:text-cyan-800 dark:text-cyan-600 dark:hover:text-green-700"
                  >
                    <ChevronLeft className="-ml-1.5" />
                    Return to cart
                  </Link>
                  <Button color="success" type="submit" disabled={processing}>
                    Pay Now
                  </Button>
                </div>
              </form>
