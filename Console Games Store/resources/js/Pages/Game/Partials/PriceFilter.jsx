...
export default function PriceFilter({ handleCheckbox, gameFilter, isMobile }) {
  return (
        ...
        <ScrollAreaLayout>
          <div className="flex items-center gap-2 w-[200px] pt-3">
            <Checkbox
              ...
              defaultChecked={
                gameFilter.price && gameFilter.price.split(",").includes("0-50")
              }
            />
            <Label
          ...
          <div className="flex items-center gap-2 w-[200px]">
            <Checkbox
              ...
              defaultChecked={
                gameFilter.price &&
                gameFilter.price.split(",").includes("50-100")
              }
            />
            <Label
          ...
          <div className="flex items-center gap-2 w-[200px]">
            <Checkbox
              ...
              defaultChecked={
                gameFilter.price &&
                gameFilter.price.split(",").includes("100-150")
              }
            />
            <Label
          ...
          <div className="flex items-center gap-2 w-[200px]">
            <Checkbox
              ...
              defaultChecked={
                gameFilter.price &&
                gameFilter.price.split(",").includes("150-200")
              }
            />
            <Label
          ...
          <div className="flex items-center gap-2 w-[200px]">
            <Checkbox
              ...
              defaultChecked={
                gameFilter.price &&
                gameFilter.price.split(",").includes("200-10000")
              }
            />
            <Label
