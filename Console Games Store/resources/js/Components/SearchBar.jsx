...
export default function SearchBar({ filters }) {
  ...
  const submit = (e) => {
    ...
    transform((data) => ({
      ...
      ...(filters?.console_generation?.length > 0 && {
        console_generation: filters.console_generation,
      }),
